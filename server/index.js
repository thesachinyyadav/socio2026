...
// Only run cron job in local development
// In production (Vercel), use the /api/cron/cleanup endpoint with Vercel Cron
if (process.env.NODE_ENV !== "production") {
  ...
  console.log("Cron job scheduled for local development");
}
